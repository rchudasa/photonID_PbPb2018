...
int photonID_bdt_MLP_classification( TString myMethodList = "" )
{
  TMVA::Tools::Instance();
 ...
 // TTree *background2   = (TTree*)input2->Get("output_tree");
  ...
  TCut mycuts = "" ; //"VBFJet_mjj > 400 && leadVBF_pt > 40 && subleadVBF_pt > 30 "; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
  TCut mycutb = "" ; //"VBFJet_mjj > 400 && leadVBF_pt > 40 && subleadVBF_pt > 30 "; // for example: TCut mycutb = "abs(var1)<0.5";
  
  dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
					  "nTrain_Signal=0.5:nTrain_Background=0.5:SplitMode=Random" );
...
int main( int argc, char** argv )
{
  ...
  return photonID_bdt_MLP_classification(methodList);
}
